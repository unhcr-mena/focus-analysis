...
```{r Registrationimp, echo=FALSE, warning=FALSE, message=FALSE, results='asis', fig.width = 10, fig.height = 7}
this.subtype <- "Registration"
source("plotindic.R")
```
...
```{r Registrationperf, echo=FALSE, warning=FALSE, message=FALSE, results='asis', fig.width = 10, fig.height = 7}
this.subtype <- "Registration"
source("plotindic2.R")
```
