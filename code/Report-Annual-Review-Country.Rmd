...
This reports provides an high level review of programme `r ctrname` as edited on the `r lastRefreshedate`.

This plan present an "operating level" budget of  `r ol.budget.2018` USD (difference of `r aol.budget.2017` USD with 2017) and an "above operating level" budget of `r aol.budget.2017` USD (difference of `r aol.budget.2017` USD with 2017)
