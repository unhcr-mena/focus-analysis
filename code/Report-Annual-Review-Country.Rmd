...
## Add order in focus 
focus1.budget$subtype.obj <- factor( focus1.budget$subtype.obj, levels =  c("Registration" ,"RSD" , "Resettlement" ,  "ChildProtection" ,"Education", "Legal", "Mixed migration", "Statelessness", "Community Services", "Community Based Protection",
...
##	Budget evolution from 2016 to 2019 at objective level – stacked by scenario.
...
ggplot(focus1.budget[focus1.budget$planningPeriod %in% c("2016","2017","2018","2019") &
                       focus1.budget$subtype.obj %in% c("Registration" ,"RSD" , "Resettlement" ,  "ChildProtection" ,"Education", "Legal", "Mixed migration", "Statelessness", "Community Services", "Community Based Protection") , ], aes(x =  planningPeriod , fill = scenario )) + 
...
```{r budgettopic2 , echo=FALSE, warning=FALSE, message=FALSE, cache=FALSE, fig.width=8, fig.height=10}
...
Impact indicators from 2016 year end till 2019 baseline are presented. A notification is inserted in the title of the chart if GSP or not.

Indicators chart can be interpreted as follows:
